...
【推理url】复制调用示例中的url：https://dashscope.aliyuncs.com/api/v1/services/aigc/multimodal-generation/generation

![image-20260203173054473](assets/image-20260203173054473.png)

登录元景万悟，点击模型管理-模型导入-通义千问-模型类型“语音识别模型”，依次填写模型名称、API Key、推理url

![image-20260205202338178](assets/image-20260205202338178.png)
