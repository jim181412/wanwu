...
func Register(openAPI *gin.RouterGroup) {
	...
	mid.Sub("openapi").Reg(openAPI, "/knowledge", http.MethodPut, openapi.UpdateKnowledge, "更新知识库", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeSystem))
	mid.Sub("openapi").Reg(openAPI, "/knowledge", http.MethodDelete, openapi.DeleteKnowledge, "删除知识库", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeSystem))
	...
	mid.Sub("openapi").Reg(openAPI, "/knowledge/doc/config", http.MethodGet, openapi.GetDocConfig, "获取文档配置信息", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeView))
	mid.Sub("openapi").Reg(openAPI, "/knowledge/doc/list", http.MethodPost, openapi.GetDocList, "获取文档列表", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeView))
	mid.Sub("openapi").Reg(openAPI, "/knowledge/doc/import", http.MethodPost, openapi.ImportDoc, "上传文档", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeEdit))
	mid.Sub("openapi").Reg(openAPI, "/knowledge/doc/update/config", http.MethodPost, openapi.UpdateDocConfig, "更新文档配置", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeEdit))
	mid.Sub("openapi").Reg(openAPI, "/knowledge/doc/import/tip", http.MethodGet, openapi.GetDocImportTip, "获取知识库文档上传状态", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeView))
	mid.Sub("openapi").Reg(openAPI, "/knowledge/doc/export", http.MethodPost, openapi.ExportKnowledgeDoc, "知识库文档导出", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeEdit))
	mid.Sub("openapi").Reg(openAPI, "/knowledge/export/record/list", http.MethodGet, openapi.GetKnowledgeExportRecordList, "获取知识库导出记录列表", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeView))
	mid.Sub("openapi").Reg(openAPI, "/knowledge/export/record", http.MethodDelete, openapi.DeleteKnowledgeExportRecord, "删除知识库库导出记录", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeEdit))
	mid.Sub("openapi").Reg(openAPI, "/knowledge/doc", http.MethodDelete, openapi.DeleteDoc, "删除文档", middleware.AuthOpenAPIKey(constant.OpenAPITypeKnowledge), middleware.AuthOpenAPIKnowledge("knowledgeId", middleware.KnowledgeEdit))
