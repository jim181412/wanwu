...
//	@Success		200		{object}	response.Response{data=response.ListResult{list=[]response.AgentSkillDetail}}
...
//	@Success		200		{object}	response.Response{data=response.AgentSkillDetail}
